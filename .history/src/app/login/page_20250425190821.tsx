...
export default function Login() {
  ...
  <button
    className={`rounded-[4px] p-4 my-2 text-xs w-full ml-1 text-white ${
      formData.gender === 1 ? 'bg-[#2D2D2D]' : 'bg-[#0000001F]'
    }`}
  ...
  <button
    className={`rounded-[4px] p-4 my-2 text-xs w-full mr-1 text-white ${
      formData.gender === 0 ? 'bg-[#2D2D2D]' : 'bg-[#0000001F]'
    }`}
