          ...
          <div className="flex items-center bg-[#0000001F] rounded-[5px] m-2 w-full">
            <div className="flex w-full text-white">
              ...
              <input
                ...
                className="bg-transparent border-l border-white  px-2 py-1 text-xs w-1/4 text-center"
              />
              <input
                type="text"
                inputMode="numeric"
                ...
                className="bg-transparent  border-l  px-2 py-1 text-xs w-1/2 text-center"
              />
            </div>
