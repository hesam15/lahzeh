        ...
        <div className="flex flex-col items-center justify-center ">
          ...
          <div className="flex items-center bg-[#0000001F] rounded-[5px] p-2 m-2 w-full">
            <input
              type="text"
              inputMode="numeric"
              className="bg-transparent text-right p-2 w-full text-white text-xs focus:outline-none appearance-none placeholder:text-gray-400"
              placeholder="روز/ماه/سال - مثلا ۰۵/۰۲/۱۴۰۳"
              value={birthDate}
