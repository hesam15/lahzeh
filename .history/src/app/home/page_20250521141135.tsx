...
export default function Home() {
  ...
  useEffect(() => {
    ...
    axios.get("http://api.lahzeh.me/api/user/post-category/")
      .then(response => {
    ...
    <div className="flex h-full w-full flex-col items-center justify-center xl:mt-3 rtl relative">
      ...
      <div className="flex flex-col items-center justify-center w-full xl:w-1/3 xl:mt-3 rounded-[8px] relative z-10">
        ...
        <div className="flex flex-row-reverse flex-wrap scrollbar-none w-full p-2 gap-2 justify-end">
          <button className="bg-[#00333E] hover:bg-[#004455] transition-colors rounded-full text-sm text-white px-4 py-2 shadow-lg">باران</button>
          <button className="bg-[#00333E] hover:bg-[#004455] transition-colors rounded-full text-sm text-white px-4 py-2 shadow-lg">دریا</button>
          <button className="bg-[#00333E] hover:bg-[#004455] transition-colors rounded-full text-sm text-white px-4 py-2 shadow-lg">جنگل</button>
          <button className="bg-[#00333E] hover:bg-[#004455] transition-colors rounded-full text-sm text-white px-4 py-2 shadow-lg">مدیتیشن</button>
          <button className="bg-[#00333E] hover:bg-[#004455] transition-colors rounded-full text-sm text-white px-4 py-2 shadow-lg">خواب</button>
        </div>
