      ...
      <div className="flex flex-col items-center justify-center bg-[#00313CCC]  w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px]">
        ...
        <div className="w-full flex flex-row itexms-center justify-between">
          ...
          <div className="flex flex-col text-white items-center justify-center">
            ...
            <div className="flex flex-row items-end justify-right text-right text-xs w-full">
              <span className="font-bold"> ۰۸:۳۰:۰۰</span>
              <span className="ml-2">:زمان خوابیدن</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <path d="M3 22a9 9 0 1 0 9-9 6 6 0 0 1-9-9"/>
  <text x="10" y="8" font-size="6" fill="currentColor" font-weight="bold">Z</text>
  <text x="14" y="12" font-size="6" fill="currentColor" font-weight="bold">Z</text>
  <text x="18" y="16" font-size="6" fill="currentColor" font-weight="bold">Z</text>
</svg>
