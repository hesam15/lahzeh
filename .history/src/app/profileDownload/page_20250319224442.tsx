...
export default function ProfileDownload() {
  ...
  const tabs = [
    ...
    {
      id: "tab1", label: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8">
    ...
    {
      id: "tab3", label: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="w-8 h-8">
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center mt-3">
      ...
      <div className="flex flex-col items-center justify-center bg-[#faf5f0]  w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px]">
        {/* تصویر فول اسکرین */}
        <div className="w-full flex flex-row itexms-center justify-between">
          ...
          <h2 className="w-full text-right text-3xl text-[#5e6472] font-bold my-5">دریا پناهی </h2>
            ...
            <div className="flex flex-col text-[#5e6472] items-end justify-right m-3">
              <div className="flex flex-row text-right text-xs">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="ml-2" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex w-full  flex-row  text-[#5e6472] items-center justify-between m-3 font-bold">
          <span>ID : 458922</span>
