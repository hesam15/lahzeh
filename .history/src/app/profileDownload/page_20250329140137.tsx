...
export default function ProfileDownload() {
  ...
  const tabs = [
    {
      id: "tab1", label: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-">
