      ...
      <div className="flex flex-col items-center justify-center bg-[#00313CCC]  w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px]">
        ...
        <div className="w-full flex flex-row itexms-center justify-between">
          ...
          <div className="flex flex-col text-white items-end justify-right">
            ...
            <div className="flex flex-row items-end justify-right text-right text-xs w-full items-end justify-right">
              <span className="font-bold"> ۰۸:۳۰:۰۰</span>
              <span className="ml-2">:زمان خوابیدن</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 30 30" fill="none" stroke="currentColor" stroke-width="0.00001" stroke-linecap="round" stroke-linejoin="round">
                <path d="M20 10A7 7 0 1 1 12 3a5 5 0 0 0 8 7Z" fill="currentColor" />
                <text x="6" y="10" font-size="5" fill="currentColor" font-weight="bold">Z</text>
                <text x="10" y="6" font-size="4" fill="currentColor" font-weight="bold">Z</text>
                <text x="14" y="4" font-size="3" fill="currentColor" font-weight="bold">Z</text>
              </svg>
