        ...
        <div className="w-full flex flex-row itexms-center justify-between">
          ...
          <h2 className="w-full text-right text-3xl text-white font-bold my-5">دریا پناهی </h2>
            ...
            <div className="flex flex-col text-white items-end justify-right m-3">
              <div className="flex flex-row text-right text-xs items-center whitespace-nowrap">
              ...
              <div className="flex flex-row text-right text-xs">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="ml-2" width="24" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
                  <polyline points="12 6 12 12 16 14" />
                </svg>
