        ...
        <div className="w-full flex flex-row itexms-center justify-between">
          ...
          <div className="flex flex-col text-white items-end justify-right">
            ...
            <div className="flex flex-row items-end justify-right text-right text-xs w-full items-end justify-right">
              ...
              <a href="https://iconscout.com/icons/sleep" class="text-underline font-size-sm" target="_blank">sleep</a> by <a href="https://iconscout.com/contributors/yogswpy" class="text-underline font-size-sm">Directico Kit</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a>
