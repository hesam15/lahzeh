...
export default function ProfileDownload() {
  ...
  const tabs = [
    {
      id: "tab1", label: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
      ...
      , content:
        <div className="text-white text-right my-6 flex flex-col items-center justify-center w-full ">
          ...
          <div className="flex flex-col">
            <PodcastRow id={""} title={""} description={""} date={""} duration={""} />
            <PodcastRow id={""} title={""} description={""} date={""} duration={""} />
            <PodcastRow id={""} title={""} description={""} date={""} duration={""} />
            <PodcastRow id={""} title={""} description={""} date={""} duration={""} />
          </div>
    ...
    {
      id: "tab2", label: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
    ...
    {
      id: "tab3", label: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
      ...
      <div className="flex flex-col items-center justify-center w-full  xl:w-1/3 mt-3 rounded-[8px]"  style={{ background: "linear-gradient(191.3deg, #007994 8.77%, #00333E 96.66%)" }}>
        ...
        <div className="w-full flex flex-row itexms-center justify-between">
          <Image
            ...
            alt="Profile Avatar" 
            className="w-[100px] h-[100px] object-cover ml-6 mt-6"
            width={100}
            height={100}
          />

          <div className="flex flex-col text-white items-end justify-right ">
          <h2 className="w-full text-right text-3xl text-white font-bold my-5 p-3">دریا پناهی </h2>
        ...
        <div className="flex w-full  flex-row  text-white items-center justify-between p-3 font-bold">
          <span>ID : 458922</span>
