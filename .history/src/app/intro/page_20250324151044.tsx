...
export default function Intro() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center mt-3 bg-[#00000080]">


      <div className="flex flex-col items-center justify-center bg-[#ede9e6] w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px] text-[#1d3557]">
