...
export default function Intro() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center mt-3">
      ...
      <div className="flex flex-col items-center justify-center bg-[#ccdbfd] w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px]">
        <Image src="/images/woman meditating.jpg" alt="Login Image" width={150} height={80} />
