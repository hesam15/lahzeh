...
export default function Intro() {
  ...
  if (isLoading) {
    return (
      <div className="w-full h-screen flex items-center justify-center bg-[#00333E] text-white text-2xl">
        در حال بارگذاری...
      </div>
    );
  }
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center mt-3">
      ...
      <div className="flex flex-col items-center justify-center w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px] text-white">
        ...
        <p className="text-right text-xs my-7 leading-7">کاربر عزیز به شما پیشنهاد میکنیم که حتما برای آشنایی کامل با ما و برنامه این ویدیو رو بصورت کامل  ببینی تا بتونی بهترین کاربری رو تجربه کنی </p>
      </div>
