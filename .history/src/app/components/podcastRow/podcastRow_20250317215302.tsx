...
const PodcastRow = () => {
  return (
    <div className="rounded-[10px] w-full p-2 text-right text-white bg-[#89b0ae] flex flex-row  m-3">
      <Image src="/images/pod.jpg" alt="Login Image" width={250} height={250} className='rounded-[10px]' />
      <div>
        <div className='my-4'>
