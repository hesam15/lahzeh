...
const PodcastRow = () => {
  return (
    <div className="rounded-[10px] w-full p-2 text-right text-white bg-[#89b0ae] flex flex-row-reverse  m-3">
      <Image src="/images/pod.jpg" alt="Login Image" width={160} height={50} className='rounded-[10px]' />
      <div className='mr-3'>
        <div className='my-4'>
          <h2>نام فایل</h2>
          <span className='text-2xs text-white text-right py-5'>این متن به عنوان نمونه برای توضیح صدا در نظر گرفته شده است و ترجیحات دوخط است.</span>
        </div>
