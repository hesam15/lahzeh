...
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div
      className={`fixed top-5 right-5 -translate-x-1/2 z-50 w-[90%] max-w-sm border px-4 py-3 rounded-xl shadow-md flex items-center justify-between transition-all back duration-300 ${typeStyles[type]}`}
    >
