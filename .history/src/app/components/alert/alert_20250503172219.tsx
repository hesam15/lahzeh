...
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div
      className={`fixed top-5 right-5 z-50 w-[90%] max-w-sm px-4 py-3 bg-white rounded-md flex items-start justify-center gap-3 transition-all duration-300 ${typeStyles[type]}`}
    >
