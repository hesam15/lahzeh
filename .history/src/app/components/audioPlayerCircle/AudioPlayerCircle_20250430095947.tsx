        ...
        <div className="flex flex-col items-center justify-center p-4">
            ...
            <div className="mt-4 w-full flex flex-col items-center">
                ...
                <input
                    ...
                    className="w-40 h-1 rounded-lg appearance-none bg-gray-400 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white"
                />
            </div>
