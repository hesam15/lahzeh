...
// import { HiMiniSpeakerWave, HiMiniSpeakerXMark } from "react-icons/hi2"; // حذف شد
import { SpeakerWave, SpeakerXMark } from 'lucide-react'; // جایگزین شد
...
const AudioPlayerCircle = () => {
    ...
    const buttonRef = useRef<HTMLButtonElement>(null); // Ref برای دکمه
        ...
        <div className="w-full flex flex-col items-center justify-center p-4">
            ...
            <div className="relative w-60 h-60">
                ...
                <svg
                    ...
                    viewBox="0 0 100 100"
                    onMouseDown={handleMouseDown} // رویداد mousedown به SVG وصل شد
                    onClick={handleClick}
                >
                    {/* Background circle */}
                    <circle
                ...
                {/* Play/Pause button */}
                <button
                    ref={buttonRef} // Ref برای دکمه
                    onClick={togglePlay} // دیگه از رویداد onClick برای دکمه استفاده میکنیم
                    className="absolute inset-0 flex items-center justify-center rounded-full bg-transparent" // پس زمینه دکمه را شفاف کردیم
                >
                    {isPlaying ? (
                         <SpeakerXMark className="w-20 h-20 text-white" />
                    ) : (
                         <SpeakerWave className="w-20 h-20 text-white" />
                    )}
                </button>
            </div>
            ...
            <div className="w-full flex flex-row items-center justify-center">
                ...
                <SpeakerWave color="white" size={30} className="m-2" />
                ...
                <SpeakerXMark color="gray" size={30} className="m-2" />
            </div>
