...
const AudioPlayerCircle = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center p-4">
            ...
            <style jsx>{`
            #myRange {
    direction: rtl; /* این ممکن است کار نکند */
    transform: scaleX(-1); /* معکوس کردن نوار */
    -webkit-appearance: none; /* حذف ظاهر پیش‌فرض */
    width: 100%; /* عرض نوار */
        background:rgb(221, 38, 38); /* رنگ دسته */
...
#myRange::-webkit-slider-thumb {
    ...
    width: 20px; /* عرض دسته */
    height: 20px; /* ارتفاع دسته */
    background:rgb(0, 33, 1); /* رنگ دسته */
...
#myRange::-moz-range-thumb {
    width: 20px; /* عرض دسته */
    height: 20px; /* ارتفاع دسته */
    background:rgb(255, 255, 255); /* رنگ دسته */
    cursor: pointer; /* نشانگر دست */
}
