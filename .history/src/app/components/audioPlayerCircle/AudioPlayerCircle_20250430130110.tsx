...
const AudioPlayerCircle = () => {
   ...
   #myRange {
    ...
    width: 100%; /* عرض نوار */
    background: #ccc; /* پس‌زمینه خاکستری */
}
...
#myRange::-webkit-slider-thumb {
    ...
    appearance: none;
    background: white; /* رنگ سفید برای thumb */
    border: 2px solid #ccc; /* حاشیه سفید برای thumb */
    width: 20px;
    height: 20px;
    border-radius: 50%;
}
...
/* بخش انتخاب شده (آبی رنگ) که باید سفید شود */
#myRange::-webkit-slider-progress {
    background: white; /* تغییر رنگ به سفید */
}
