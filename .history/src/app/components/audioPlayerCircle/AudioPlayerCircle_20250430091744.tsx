...
const AudioPlayerCircle = () => {
    ...
    useEffect(() => {
        ...
        if (slider) {
          ...
          slider.style.background = `linear-gradient(to right, white ${percent}%, #666 ${percent}%)`;
        }
      }, [volume]);
 ...
 .volume-slider {
  ...
  height: 6px;
  border-radius: 5px;
  background: linear-gradient(to right, white 50%, #666 50%);
...
/* Chrome dynamic background update */
