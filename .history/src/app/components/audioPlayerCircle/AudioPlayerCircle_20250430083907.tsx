        ...
        <div className="flex flex-col items-center justify-center p-4">
            ...
            <div className="mt-4 w-full flex flex-col items-center">
                ...
                <input
                    ...
                    className="z-50 relative w-32 h-2 rounded-lg appearance-none cursor-pointer"
                    style={{
                        background: `linear-gradient(to right, white ${volume * 100}%, #6b7280 ${volume * 100}%)`, // خاکستری = gray-500
                        borderRadius: "1rem",
                        height: "6px",
