...
export default function MusicPlayer() {
    ...
    return (
        ...
        >
            ...
            <div
                className={`transition-all duration-300 w-full backdrop-blur-md text-white rounded-t-2xl ${showPlayer ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                    }`}
