...
export const MusicPlayer: React.FC<PlayerProps> = ({ data }) => {
    ...
    return (
        ...
        >
            <div
                className={`z-10 backdrop-blur-md w-full flex items-end justify-center flex-col text-white rounded-t-2xl transition-all duration-300 ${showPlayer ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                    }`}
