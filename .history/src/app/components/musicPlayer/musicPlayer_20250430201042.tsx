...
export default function MusicPlayer() {
    ...
    return (
        ...
        >
            {showPlayer && (
                <div
                    className="backdrop-blur-md w-full flex items-end justify-center flex-col text-white rounded-t-2xl transition-all duration-300"
                    onClick={handleInnerClick} // جلوگیری از بسته شدن با کلیک داخل پلیر
                >
