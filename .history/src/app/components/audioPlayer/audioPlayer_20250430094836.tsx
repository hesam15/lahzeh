            ...
            <div className="flex flex-col items-center justify-center w-full">
                ...
                {activeTab === 'main' ? (
                    <>
                        ...
                        <div className='w-4/5 flex flex-row justify-between mt-2 px-2'>

                                    <HiOutlineHeart className="w-8 h-8 p-1 bg-black rounded-[100%]" />
                                    <HiOutlineChartBar className="w-8 h-8 p-1 bg-black  rounded-[100%]" />
                                    <HiOutlineShare className="w-8 h-8 p-2 bg-black  rounded-[100%]" />
                                    <HiOutlineBookmark className="w-8 h-8 p-2 bg-black  rounded-[100%]" />
                        </div>
                    </>
                ) : (
