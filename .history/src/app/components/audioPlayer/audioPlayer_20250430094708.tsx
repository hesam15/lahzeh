                ...
                {activeTab === 'main' ? (
                    <>
                        ...
                        <div className='w-full flex flex-row justify-between mt-2 px-2'>
                                    ...
                                    <HiOutlineHeart className="w-8 h-8 p-2 bg-black rounded" />
                                    <HiOutlineChartBar className="w-4 h-4 p-2 bg-black rounded" />
                                    <HiOutlineShare className="w-5 h-5 p-2 bg-black rounded" />
                                    <HiOutlineBookmark className="w-5 h-5 p-2 bg-black rounded" />
                        </div>
                    </>
                ) : (
