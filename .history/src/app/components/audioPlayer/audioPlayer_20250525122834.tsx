...
type AudioPlayerProps = {
    data: any; // یا اگر نوع دقیق رو می‌دونی، به‌جای any استفاده کن
};
const AudioPlayerCircle: React.FC<AudioPlayerProps> = ({ data }) => {
const AudioPlayer: React.FC = ({ data }) => {
    ...
    return (
        <div className="p-2 flex flex-col items-center w-full">
            <audio ref={audioRef} src={data?.navigation?.file_path} preload="auto"  />
            ...
            <div className="flex flex-col items-center justify-center w-full">
                <div className="w-full flex justify-center gap-4 mb-4">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-300 z-50 ${activeTab === 'main'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-300 z-50 ${activeTab === 'effects'
                            ? 'bg-white/20 text-white'
                            : 'text-white/60 hover:text-white/80'
                            }`}
                    >
                ...
                {activeTab === 'main' ? (
                    <>
                        ...
                        <div className='w-4/5 flex flex-row justify-between mt-2'>
                            ...
                            <div className=' bg-[#0000006e] rounded-[100%] p-2  border border-gray-500'> <HiOutlineHeart className="w-6 h-6" /></div>
                            <div className=' bg-[#0000006e] rounded-[100%] p-2  border border-gray-500'>   <HiOutlineChartBar className="w-6 h-6" /></div>
                            <div className=' bg-[#0000006e] rounded-[100%] p-2  border border-gray-500'>  <HiOutlineShare className="w-6 h-6" /></div>
                            <div className=' bg-[#0000006e] rounded-[100%] p-2  border border-gray-500'>  <HiOutlineBookmark className="w-6 h-6" /></div>
                        </div>
                    </>
                ) : (
