    ...
    const handleShare = async () => {
        try {
            if (navigator.share) {
                ...
                // اگر Web Share API پشتیبانی نشد، از کلیپ‌بورد استفاده می‌کنیم
                ...
                {activeTab === 'main' ? (
                    <>
                        ...
                        <button
                            ...
                            className="text-white p-3 rounded-full m-2 border border-white/30 hover:border-white/50 hover:bg-white/10 transition-all duration-300"
                        >
                            {isPlaying ? (
                        ...
                        <div className='w-full flex flex-row justify-between mt-2 px-2'>
                            <div className="w-1/3 flex justify-end items-center gap-4">
                                <div className="flex items-center justify-center gap-1 text-white/80 hover:text-white transition-colors">
                                    ...
                                    <span className="text-xs p-0 m-0">2.5K</span>
                                </div>
