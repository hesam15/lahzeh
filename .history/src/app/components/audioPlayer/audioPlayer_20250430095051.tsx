                ...
                {activeTab === 'main' ? (
                    <>
                        ...
                        <div className='w-4/5 flex flex-row justify-between mt-2'>
                                   ...
                                   <div className=' bg-black rounded-[100%] p-3'> <HiOutlineHeart className="w-8 h-8" /></div>
                                    <HiOutlineChartBar className="w-8 h-8 bg-black  rounded-[100%]" />
                                    <HiOutlineShare className="w-8 h-8 bg-black  rounded-[100%]" />
