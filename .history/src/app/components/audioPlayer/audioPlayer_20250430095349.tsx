                ...
                {activeTab === 'main' ? (
                    <>
                        ...
                        <div className='w-4/5 flex flex-row justify-between mt-2'>
                                   ...
                                   <div className=' bg-[#0000006e] rounded-[100%] p-2'> <HiOutlineHeart className="w-7 h-7" /></div>
                                   <div className=' bg-[#0000006e] rounded-[100%] p-2'>   <HiOutlineChartBar className="w-7 h-7" /></div>
                                   <div className=' bg-[#0000006e] rounded-[100%] p-2'>  <HiOutlineShare className="w-6 h-6" /></div>
                                   <div className=' bg-[#0000006e] rounded-[100%] p-2'>  <HiOutlineBookmark className="w-7 h-6" /></div>
                        </div>
                    </>
                ) : (
