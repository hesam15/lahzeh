...
const Footer = () => {
  return (
    <div className="w-1/3 fixed flex flex-row rounded-t-[20px] bg-[#00293299] items-center justify-center bottom-0">
      <div className='flex flex-col text-white p-4'>
          <Image src="/icons/Customer.png" alt="Login Image" width={30} height={30} />
          <span>پروفایل</span>
      </div>
      <div className='flex flex-col text-white p-4'>
          <Image src="/icons/Moon and Stars.png" alt="Login Image" width={30} height={50} />
          <span>خواب</span>
      </div>
      <div className='flex flex-col text-white p-4'>
