...
const AudioVolumeSlider: React.FC = () => {
    ...
    return (
        <div className='flex w-full flex-col items-center justify-center p-8'>
            <div className='flex w-9/10 items-center justify-center flex-col my-5'>
            <div className="flex items-center w-full justify-center relative">
                    <Image src="/images/rain.png" alt="rain" width={50} height={50} />
                    <div className="relative flex-1">
                        <span className="text-white text-sm absolute -top-6 left-3">{Math.round(volume1 * 100)}%</span>
            ...
            <div className='flex w-2/3 items-center justify-center flex-col my-5'>
                <div className="flex items-center w-full justify-center relative">
                    <Image src="/images/Nature.png" alt="nature" width={50} height={50} />
                    <div className="relative flex-1">
                        <span className="text-white text-sm absolute -top-6 left-3">{Math.round(volume2 * 100)}%</span>
            ...
            <div className='flex w-2/3 items-center justify-center flex-col my-5'>
                <div className="flex items-center w-full justify-center relative">
                    <Image src="/images/Sea Waves.png" alt="sea" width={50} height={50} />
                    <div className="relative flex-1">
                        <span className="text-white text-sm absolute -top-6 left-3">{Math.round(volume3 * 100)}%</span>
