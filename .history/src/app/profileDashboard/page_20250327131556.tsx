      ...
      <div className="flex h-full w-full flex-col items-center justify-center mt-3">
        <div className="flex flex-col items-center justify-center  w-8/9  xl:w-1/3 mt-3 rounded-[8px]" style={{ background: "linear-gradient(191.3deg, #007994 8.77%, #00333E 96.66%)" }}>
          ...
          <div className="flex flex-row-reverse gap-1 justify-end w-full my-4">
            <button className="rounded-[30px] text-xs text-white py-6 flex flex-col items-center justify-center m-4 min-w-[300px] w-[300px] h-[300px]" style={{
            ...
            <button className="rounded-[30px] text-xs text-white py-6 flex flex-col items-center justify-center min-w-[300px] m-4 w-[300px] h-[300px]" style={{
              background: "linear-gradient(224.11deg, #004C5C 4.09%, rgba(0, 0, 0, 0.36) 95.9%)",
              boxShadow: "0px 4px 4px 0px #00000040"
            }}
              onClick={handleClick}
            ...
            <button className="rounded-[30px] text-xs text-white py-6 flex flex-col items-center justify-center m-4 min-w-[100px] w-[300px] h-[300px]" style={{
              background: "linear-gradient(224.11deg, #004C5C 4.09%, rgba(0, 0, 0, 0.36) 95.9%)",
              boxShadow: "0px 4px 4px 0px #00000040"
            }}
              onClick={handleClick}
