    ...
    <div className="flex h-full w-full flex-col items-center justify-center mt-3">
      ...
      <div className="flex flex-col items-center justify-center bg-[#00313CCC]  w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px]">
        ...
        <div className="flex flex-wrap gap-1 justify-end w-full">
          <button className="bg-[#00333E] rounded-[30px] text-xs text-white py-12  w-1/3 flex flex-col items-center justify-center">
            <span>داشبورد</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="w-6 h-6">
