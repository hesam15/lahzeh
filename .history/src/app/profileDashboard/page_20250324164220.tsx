  ...
  return (
    <div className="flex flex-col h-full w-full">
      <div className="flex h-full w-full flex-col items-center justify-center mt-3">
        <div className="flex flex-col items-center justify-center  w-8/9  xl:w-1/3 mt-3 p-2 rounded-[8px]" style={{ background: "linear-gradient(191.3deg, #007994 8.77%, #00333E 96.66%)" }}>
          {/* تصویر فول اسکرین */}
          <Image
            src="/images/vip.png"
