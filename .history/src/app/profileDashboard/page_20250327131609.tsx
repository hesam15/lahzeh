  ...
  return (
    <div className="flex flex-col h-full w-full">
      <div className="flex h-full w-full flex-col items-center justify-center mt-3">
        <div className="flex flex-col items-center justify-center  w-8/9  xl:w-1/3 mt-3 rounded-[8px]" style={{ background: "linear-gradient(191.3deg, #007994 8.77%, #00333E 96.66%)" }}>
          {/* تصویر فول اسکرین */}
          <div className="relative">
            ...
            <Image
              ...
              alt="Background Image"
              className="rounded-[300px] absolute -top-5 -left-10 -rotate-15"
              width={100}
              height={100}
            />
          </div>
          ...
          <div className="flex flex-col text-white items-center justify-center">
            ...
            <h3 className="text-gray-200">۰۹۳۶۹۴۹۱۹۴۲</h3>
            <h4 className="text-gray-200">User ID : 458922</h4>
          </div>

          <div className="flex flex-row-reverse gap-1 justify-end w-full my-4">
            <button className="rounded-[30px] text-xs text-white py-6 flex flex-col items-center justify-center m-4 min-w-[100px] w-[100px] h-[100px]" style={{
              background: "linear-gradient(224.11deg, #004C5C 4.09%, rgba(0, 0, 0, 0.36) 95.9%)",
            ...
            <button className="rounded-[30px] text-xs text-white py-6 flex flex-col items-center justify-center min-w-[100px] m-4 w-[100px] h-[100px]" style={{
              background: "linear-gradient(224.11deg, #004C5C 4.09%, rgba(0, 0, 0, 0.36) 95.9%)",
              boxShadow: "0px 4px 4px 0px #00000040"
            }}
              onClick={handleClick}
            ...
            <button className="rounded-[30px] text-xs text-white py-6 flex flex-col items-center justify-center m-4 min-w-[100px] w-[300px] h-[100px]" style={{
              background: "linear-gradient(224.11deg, #004C5C 4.09%, rgba(0, 0, 0, 0.36) 95.9%)",
              boxShadow: "0px 4px 4px 0px #00000040"
            }}
              onClick={handleClick}
          ...
          <div className="relative bg-[#1B76FFA1] rounded-[13px] py-4 px-1 text-white flex flex-col items-center justify-center w-full" >
            <span className="text-xs">دانیال عزیز آخرین محتوایی که گوش هات رو بهش سپردی</span>
            <span className="text-sm m-4">“خواب قسمت ۶ “</span>
          ...
          <div className="text-white text-right my-6 flex flex-col items-center justify-center w-full ">
            <div className="flex flex-row items-center justify-between w-full">
              <button className="text-xs bg-[#003844] p-3 rounded-[10px] flex-nowrap flex flex-row-reverse items-center justify-center text-white">مشاهده همه</button>
