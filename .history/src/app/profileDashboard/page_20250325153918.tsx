  ...
  return (
    <div className="flex flex-col h-full w-full">
      <div className="flex h-full w-full flex-col items-center justify-center mt-3">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-[#00333E] p-4 flex justify-around items-center">
          <button className="flex flex-col items-center text-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z" />
            </svg>
            <span className="text-xs mt-1">اشتراک گذاری</span>
          </button>
          ...
          <button className="flex flex-col items-center text-white">
            ...
            <span className="text-xs mt-1">بوکمارک</span>
          </button>
          ...
          <button className="flex flex-col items-center text-white">
            ...
            <span className="text-xs mt-1">دانلود</span>
          </button>
        </div>
