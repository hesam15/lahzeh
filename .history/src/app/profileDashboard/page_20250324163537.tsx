...
export default function ProfileDashboard() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center mt-3">
      ...
      <div className="flex flex-col items-center justify-center  w-8/9  xl:w-1/3 mt-3 p-5 rounded-[8px]"  style={{ background: "linear-gradient(191.3deg, #007994 8.77%, #00333E 96.66%)" }}>
        {/* تصویر فول اسکرین */}
        <Image
          src="/images/vip.png"
        ...
        <div className="flex flex-row gap-1 justify-end w-full my-4">
          <button className="rounded-[30px] text-xs text-white py-6  w-1/3 flex flex-col items-center justify-center" style={{background: "linear-gradient(224.11deg, #004C5C 4.09%, rgba(0, 0, 0, 0.36) 95.9%)",box-shadow: "0px 4px 4px 0px #00000040"}}>
        <></>

          </button>
          <button className="bg-[#aed9e0] rounded-[30px] text-xs text-white py-6  w-1/3 flex flex-col items-center justify-center"  onClick={handleClick}> 
        ...
        <div className="relative bg-[#ffa69e] rounded-[13px] p-5 text-white flex flex-col items-center w-full">
        ...
        <div className="text-white text-right my-6 flex flex-col items-center justify-center w-full ">
          <div className="flex flex-row items-center justify-between w-full">
            <button className="text-xs bg-[#aed9e0] p-3 rounded-[10px] flex-nowrap flex flex-row-reverse items-center justify-center text-white">مشاهده همه</button>
        ...
        <div className="text-white bg-[#aed9e0] rounded-[9px] m-5 xl:m-0 p-4 text-right ">
